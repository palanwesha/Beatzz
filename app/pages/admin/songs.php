  				...
  				<?php if(!empty($rows)):?>
	  				<?php foreach($rows as $row):?>
		  				<tr>
		  					...
		  					<td><center><img src="<?=ROOT?>/<?=$row['image']?>" style="width:100px;height: 100px;object-fit: cover;"></center></td>
		  					<td><center><?=get_category($row['category_id'])?></center></td>
		  					<td><center><?=get_artist($row['artist_id'])?></center></td>
		  					<td><center>
		  						<audio controls>
